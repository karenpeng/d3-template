...
exports.makeScatterPlot = makeScatterPlot;
var margin = { top: 40, right: 40, bottom: 40, left: 40 },
    width = 960,
    height = 500;

var x = pad(d3.scale.linear().range([0, width - margin.left - margin.right]), 40);

var y = pad(d3.scale.linear().range([height - margin.top - margin.bottom, 0]), 40);

var xAxis = d3.svg.axis().scale(x).orient("bottom").tickPadding(8);

var yAxis = d3.svg.axis().scale(y).orient("left").tickPadding(8);

var svg = d3.select("body").append("svg").attr("width", width).attr("height", height).attr("class", "dot chart").append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
_d32['default'].csv('../../data/data.csv', function (err, data) {
  (0, _chartsScatterplotJs.makeScatterPlot)(data);
});

},{"./charts/scatterplot.js":2,"d3":1}]},{},[3])
